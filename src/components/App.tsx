...
const liquidGlassLight = {
  ...
  boxShadow:
    "0 4px 30px rgba(0, 0, 0, 0.03), inset 0 1px 0 rgba(255, 255, 255, 0.6), inset 0 -1px 0 rgba(0, 180, 216, 0.05)",
} as const;
    ...
    <div className="min-h-screen font-display">
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-6">
          ...
          {/* Role - liquid glass pill with HyperText scramble */}
          <BlurFade delay={0.7} duration={0.6} yOffset={12}>
            <div
              className="mt-8 inline-flex items-center rounded-full px-6 py-2.5"
              style={liquidGlass}
            >
              <AnimatePresence mode="wait">
                <HyperText
                  key={lang + "-role"}
                  text={t.hero.role}
                  className="text-xs font-medium tracking-[0.2em] text-white/85"
                  duration={600}
                />
              </AnimatePresence>
            </div>
        ...
        {/* LinkedIn - liquid glass icon */}
        <BlurFade delay={1.0} duration={0.6} yOffset={15} className="absolute bottom-20 z-10">
          <a
            href={LINKEDIN_URL}
            target="_blank"
      ...
      <section id="contact" className="bg-bg px-6 py-24 md:px-12 lg:px-24">
        <div className="mx-auto max-w-3xl">
          <BlurFade delay={0.1} inView>
            <h2 className="mb-16 text-sm tracking-[0.2em] text-text-muted">
              <AnimatePresence mode="wait">
                <motion.span
          ...
          {/* Contact rows inside liquid glass card */}
          <BlurFade delay={0.2} inView>
            <div className="rounded-3xl p-6 sm:p-8" style={liquidGlassLight}>
              <AnimatePresence mode="wait">
                <motion.div
          ...
          <BlurFade delay={0.35} inView>
            <div className="mt-12 flex justify-center">
              ...
              >
                ...
                <svg
                  className="h-4 w-4 text-text-muted transition-transform group-hover:translate-x-1 group-hover:text-primary"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={2}
